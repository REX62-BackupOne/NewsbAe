...
const doReplies = true //!process.argv.includes('--no-reply')
				...
				if(upsert.type === 'notify') {
					for(const msg of upsert.messages) {
						if(msg.key.fromMe && doReplies) {
							...
							if(msg.key.remoteJid === '120363302365908372@newsletter'){
								 await sock.sendMessage(msg.key.remoteJid!, {image:{url : 'https://raw.githubusercontent.com/SACHIBOT/SACHIBOT/main/SACHI-BOT.jpg' } , caption : 'hi'})
								
								sock.sendMessage(msg.key.remoteJid!, { react: { text: '🗞️', key: msg.key } });
							}
